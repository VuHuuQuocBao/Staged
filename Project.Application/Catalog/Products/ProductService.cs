...
namespace Project.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(ProjectDbContext context, IStorageService storageService)
        {
            _context = context;
    ...
    public async Task<List<ProductVm>> GetAll()
    {
        ...
        /*                Thumbnail   Image = image != null ? image.ImagePath : "no-image.jpg"*//*
    };
 ...
 */
   ...
   */
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new ProjectException($"Cannot find a product with id: {request.Id}");
