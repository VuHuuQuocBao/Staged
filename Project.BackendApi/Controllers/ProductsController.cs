...
namespace Project.BackendApi.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            // neu' ko await thi' ra loi~ notsupporttedexception serialization and deserialization
        ...
        public async Task<IActionResult> Create([FromForm] ProductCreateRequest request)
        {
            ...
            *//*var product = await _productService.GetById(productId, request.LanguageId);*//*
            ...
            //xem lai phuong thuc nay
            *//*return CreatedAtAction(nameof(_productService.GetById), new { id = productId }, product);*//*
            return Ok();
        }
    }
}*/
...
namespace Products.BackendApi.Controllers
{
    //api/products
    [Route("api/[controller]")]
    [ApiController]
